...
(function ($) {
  ...
  $.fn.createWhatsappChatWidget = async function (userId) {
    jQuery(document).ready(function ($) {
      var jsonp_url = "http://localhost/montero/get_widget_content.php";
      $.getJSON(jsonp_url, function (data) {
        var custom_div = document.getElementById("custom_widget_mhJvJCZ3rn");
        custom_div.innerHTML = data.widget_html;
        var custom_style = document.createElement("style");
        custom_style.innerHTML = data.widget_css;
        var div = document.getElementById("custom_widget_mhJvJCZ3rn");
        insertAfter(div, custom_style);
      });
    });
    var scriptElement = JSON.stringify(document.currentScript.src)
      .split("&")[1]
      .split('"')[0];
    console.log("scriptElement", userId);
    var options = await fetch(
      // `http://localhost:8080/widget-content/${scriptElement}`
      `${process.env.REACT_APP_API_BASE_URL}/widget-content/${userId}`
    )
      .then((response) => {
        if (response.ok) {
    ...
    // console.log("Option", option.enabled);
        ...
        `<div class='wa-chat-box'>
                       ...
                       <a
                          ...
                          href="https://api.whatsapp.com/send?phone=${
                            option.brandSetting.phoneNumber
                          }&text=${
          option.brandSetting.messageText ? option.brandSetting.messageText : ""
                        ...
                        <a
                          href="https://ulai.in/"
                          target="_blank"
                          class="wa-chat-box-poweredby-link"
                        >
                          <img
                            src="https://www.ulai.in/file-server/uploads/Ulai/ulai-logo.jpeg"
                            style="width: 35px"
                            alt=""
                            srcset=""
                        /></a>
    ...
    var styles = `
                ...
                .wa-chat-bubble{
                    display: ${
                      option.chatButtonSetting.ctaText ? "flex" : "none"
                    };
                    align-items: center;
                    gap: 8px;
                    z-index: 16000160 !important;
                ...
                .wa-chat-bubble-close-button{
                    ...
                    justify-content: center;
                    order: ${
                      option.chatButtonSetting.position == "left" ? "0" : "1"
                    };
                }
                .wa-chat-bubble-text{
                   font-family: 'Outfit', sans-serif !important;
...
(function ($) {
  $.fn.myCustomFunction = function () {
    // console.log('My custom jQuery function is called!');
