...
import UserCard from "../../../assets/images/user-card/5.jpg";
import Success from "../../../assets/images/email-template/success.png";
  ...
  series: [
    {
      ...
      // generateMinuteWiseTimeSeries(new Date('12/12/2016 00:20:00').getTime(), 12, {
      //     min: 10,
      //     max: 110
      // })
    },
...
export const uses = {
  options: {
    ...
    //colors: ['#37a8c3', '#2f758d', '#222222', '#e2c636'],
    title: {
