    ...
    <Col sm="12">
      <Card>
        ...
        <CardBody>
          ...
          <Footer attrFooter={{ className: "blockquote-footer mt-0" }}>
            {"Someone famous in"}
            <cite title="Source Title">{SourceTitle}</cite>
          </Footer>
          <P attrPara={{ className: "sub-title" }}>{"Alignment Center"}</P>
          <BlockQuotes
            attrBlockQuote={{ className: "blockquote text-center mb-0" }}
          >
            <P attrPara={{ className: "mb-0" }}>
              {"Lorem ipsum dolor sit amet"}
              {", consectetur adipiscing elit. Integer posuere erat a ante."}
          ...
          <Footer
            attrFooter={{ className: "blockquote-footer text-center mt-0" }}
          >
            {"Someone famous in"}
            <cite title="Source Title">{SourceTitle}</cite>
          </Footer>
          ...
          <BlockQuotes
            attrBlockQuote={{ className: "blockquote text-end mb-0" }}
          >
            <P attrPara={{ className: "mb-0" }}>
              {"Lorem ipsum dolor sit amet"}
              {", consectetur adipiscing elit. Integer posuere erat a ante."}
          ...
          <Footer attrFooter={{ className: "blockquote-footer text-end mt-0" }}>
            {"Someone famous in"}
            <cite title="Source Title">{SourceTitle}</cite>
          </Footer>
        </CardBody>
