  ...
  return (
    <div className="d-flex flex-column align-items-left">
        <div className='mb-2'>
            ...
            <p className="mb-2">Copy and paste this code before the tag on every page of your website.</p>
        </div>
        <div className="w-100 d-flex flex-wrap gap-2 justify-content-between align-items-center mb-4">
        <button style={{cursor: 'none'}} type="text" className="btn btn-outline-none fw-bolder border border-lightgray">Javascript</button>
        </div>
        <div style={{background: 'whitesmoke'}} className='w-100 d-flex flex-wrap gap-2 align-items-center  py-5 px-4'>
         <div style={{width: '90%'}}>
