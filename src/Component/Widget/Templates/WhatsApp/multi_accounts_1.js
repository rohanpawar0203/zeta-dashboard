export const multi_accounts_1 = {
    ...
    popup: {
      ...
      {
        avatar: {
          src: '<img src="../../../../../public/main-file/assets/img/person/1.jpg" alt="">', /* Image, Icon or SVG */
      ...
      {
        avatar: {
          src: '<img src="../../../../../public/main-file/assets/img/person/2.jpg" alt="">', /* Font, Image or SVG */
          backgroudColor: "#ffffff", /* Html color code */
          onlineCircle: true /* Avatar online circle. To remove, (onlineCircle:false) */
        },
        text: {
      ...
      {
        avatar: {
          src: '<img src="../../../../../public/main-file/assets/img/person/3.jpg" alt="">', /* Font, Image or SVG */
          backgroudColor: "#ffffff", /* Html color code */
          onlineCircle: true /* Avatar online circle. To remove, (onlineCircle:false) */
        },
        text: {
